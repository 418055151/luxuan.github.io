...
<style scoped>
  ...
  .firmcontainer ul .list-item .item-take h4{
    height: auto;
    max-height: 0.6896551724137931rem;
  ...
  .item-take p{
    ...
    margin-top: 0.5172413793103449rem;
  }
  .mui-ellipsis{
    overflow: hidden;
    white-space: nowrap;
